-- ----------------------------------------------------------------------------
-- MULTI-CLASS VEHICLE FACET
--
-- An article heading can govern several vehicle classes at once -- Điều 21 of
-- ND 168 covers "xe ô tô tải, máy kéo" -- so storing one label forced an
-- arbitrary tie-break that filed every truck provision under works vehicles and
-- demoted it out of the results for truck questions. The facet is a jsonb array
-- now and the test is containment.
-- ----------------------------------------------------------------------------
