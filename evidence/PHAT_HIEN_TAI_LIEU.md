...
| :--- | :--- | :--- |
| "995 active tests across 37 test files" | 266 test | `uv run pytest --collect-only -q \| tail -2` |
...
"phê duyệt sản xuất vô điều kiện" cho một hệ thống có 266 test chứ không phải
...
| "995/995 active test cases passing" | 266 |
